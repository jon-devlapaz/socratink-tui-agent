...
export const CANONICAL_LEARNER_LOOP_EVENTS = Object.freeze({
  ...
  substrate_seed_requested: def("substrate_seed_requested", {
    source_event_types: ["launch_attempt"],
  }),
...
const LEGACY_TO_CANONICAL = Object.freeze({
  ...
  launch_attempt: ["loop_started", "substrate_seed_requested"],
  substrate_seed_offered: ["substrate_seed_shown"],
...
function payloadFor(canonicalType, legacyEvent) {
  if (canonicalType === "substrate_seed_shown") {
    return {
