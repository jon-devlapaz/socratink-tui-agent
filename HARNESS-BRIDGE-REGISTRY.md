...
| `evaluate-attempt` | `evaluator` | `socratink-evaluator-v8` | ai_service.DrillEvaluation | cold_attempt, post_bridge_transfer, spaced_redrill | cold_attempt, cold_help_turn, cold_support_exhausted, post_bridge_transfer_check, spaced_redrill, evidence_hold_recorded | See [evaluator routing](#evaluate-attempt) |
