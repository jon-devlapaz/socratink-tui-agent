...
- Baseline: `node --test tests/js/lab-api.test.mjs tests/js/lab-runs.test.mjs` passed 30/30 before workbench edits.
...
- Validation: `node --test tests/js/lab-api.test.mjs tests/js/lab-runs.test.mjs` passed 32/32 after edits.
