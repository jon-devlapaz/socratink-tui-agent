...
const EVENT_DOCS = Object.freeze({
  default: ["lib/seda/event-facts.mjs", "lib/seda/next-phase.mjs", ".mex/context/seda-harness.md"],
  substrate: [".mex/context/product-vocabulary.md", "lib/seda/handlers/substrate-gate.mjs"],
...
function docsFor(group, bridgeActions) {
  return [
    ...EVENT_DOCS.default,
    ...(EVENT_DOCS[group] || []),
    ...(bridgeActions.length ? ["lib/bridge/registry.json", ".mex/context/bridge.md"] : []),
