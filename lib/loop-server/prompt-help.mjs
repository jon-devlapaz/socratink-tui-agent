...
export const IDLE_STARTUP_LINE =
  "Type a concept to explore · /help · /meta · /feedback <message> · /exit";
...
export function printIdleHelp() {
  ...
  console.log(
    "[Help] Commands: /help (this step) · /meta (why this step) · /feedback <note> · /exit · /hint (repair only). Dogfood: map is a draft, not your grade; sessions reset when we redeploy.",
  );
}
