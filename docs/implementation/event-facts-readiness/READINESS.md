...
lib/observability/dashboard-metrics.mjs             | 46 +++++++++++-------------------
...
- Dashboard product metric formulas still use canonical events in
  `lib/observability/dashboard-metrics.mjs:257-280`; event facts only drive summary
  memberships at `lib/observability/dashboard-metrics.mjs:206-232`.
